...
class OpenIDConnectClient
{
     ...
     */
    public function setResponseTypes(array|string $response_types)
    {
    ...
    public function authenticate(): bool
    {
        ...
        if (isset($_REQUEST['code'])) {
            ...
            if ($this->processIdToken($id_token, $token_json->access_token)) {
        ...
        if ($this->allowImplicitFlow && isset($_REQUEST['id_token'])) {
            ...
            if ($this->processIdToken($id_token, $accessToken)) {
                return true;
            }
    ...
    private function processIdToken(string $id_token, ?string $accessToken): bool
    {
    ...
    public function verifyLogoutTokenClaims($claims): bool
    {
        ...
        if (isset($claims->events)) {
            ...
            if (
                !isset($events['http://schemas.openid.net/event/backchannel-logout']) ||
    ...
    private $userAgent = 'no1service/openid-connect';
